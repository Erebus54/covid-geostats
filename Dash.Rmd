...
```{r}
pal <- colorNumeric("Blues", domain = csum_map$Cases_pC, reverse = F)
...
```{r}
pal <- colorNumeric("Greens", domain = csum_map$Recovered_pC, reverse = F)
...
```{r}
pal <- colorNumeric("Oranges", domain = csum_map$Actives_pC, reverse = F)
...
```{r}
pal <- colorNumeric("Reds", domain = csum_map$Deaths_pC, reverse = F)
